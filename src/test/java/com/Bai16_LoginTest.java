...
public class Bai16_LoginTest extends BasicTest {
    ...
    public void loginTest(String uname, String pass, String expected, String errorMessage) throws Exception {
        ...
        if (expected.equals("success")) {
            txt = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[contains(@class,'logout')]//a"))).getText();
            // WebElement loginSuccess = driver.findElement(By.xpath("//li[contains(@class,'logout')]//a"));
            Assert.assertEquals(txt, "Thoát");
        } else {
            txt = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ul[@class='woocommerce-error']"))).getText();
            // WebElement ErrorMessage = driver.findElement(By.xpath("//ul[@class='woocommerce-error']"));
            Assert.assertEquals(txt, errorMessage);
        }
    ...
    public Object[][] testdata(){
        Object[][] testDataFeed = new Object[1][4];
