Feature: Booking functionality
  ...
  Scenario: Checking maximum number of booking rooms, adult persons, and children
    ...
    And clicks the plus button for adult persons 20 times
    And clicks the plus button for adult persons 20 more times
    And clicks the plus button for children 8 times
    And clicks the plus button for children 8 more times
    Then the maximum number of booking rooms should be 9
    And the maximum number of adult persons should be 30
    And the maximum number of child rooms should be 12
